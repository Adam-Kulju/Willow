...
int movescore(struct board_info *board, struct list *list, int depth, bool color, struct ttentry entry, char type, struct move lastmove, int movelen, int threshold, ThreadInfo *thread_info)
{
